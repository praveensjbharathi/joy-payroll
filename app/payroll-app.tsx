    ...
    <div className="app-shell">
      ...
      <div className="main-column">
        ...
        <main className="content">
          ...
          {activeSection === "recoveries" ? <RecoveryCenter run={currentRun} employees={currentEmployees} items={currentItems} charges={data.accommodationCharges} data={data} canManage={mayManage("recoveries") && currentRun?.status !== "approved"} isActing={isActing} onAction={performAction} /> : null}
...
function PaymentsView({ run, items, employees, canExport, onPayslip, onBulkPayslips }: { run: PayrollRun; items: PayrollItem[]; employees: Employee[]; canExport: boolean; onPayslip: (item: PayrollItem) => void; onBulkPayslips: () => void }) {
