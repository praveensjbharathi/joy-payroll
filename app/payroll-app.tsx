    ...
    <div className="app-shell">
      ...
      <div className="main-column">
        ...
        <main className="content">
          ...
          {!currentRun && !["dashboard", "accommodation", "hostels", "vendors", "settings", "employees", "masters", "users"].includes(activeSection) ? (
