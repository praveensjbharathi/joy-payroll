...
function EmployeesView({ employees, canManage, onAdd, onEdit, onImport, onStatus, onDelete }: { employees: Employee[]; canManage: boolean; onAdd: () => void; onEdit: (employee: Employee) => void; onImport: () => void; onStatus: (employee: Employee) => void; onDelete: (employee: Employee) => void }) {
  const [query, setQuery] = useState("");
