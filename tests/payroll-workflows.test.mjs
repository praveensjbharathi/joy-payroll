...
test("client, employer, employee, shift, remark, payroll, and workbook management workflows", async () => {
  ...
  try {
    ...
    for (const migration of ["0000_superb_goblin_queen.sql", "0001_icy_tony_stark.sql", "0002_sparkling_dark_beast.sql", "0003_elite_maginty.sql", "0004_payroll_accommodation_access_enhancements.sql", "0005_unit_attendance_cycle_payslip_fields.sql", "0006_direct_employee_vehicle_utility_operations.sql", "0007_hostel_master_utilities.sql", "0008_link_hostels_to_accommodation_types.sql"]) {
